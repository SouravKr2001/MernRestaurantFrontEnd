...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (email && password) {
      // const fetchData = await fetch("http://localhost:5500/login", {
        const fetchData = await fetch("https://mernrestaurantbackend.onrender.com/login", {
      ...
      // alert("Success");
    } else alert("Please enter the required field");
  };
